...
namespace SkyAtmosphere
{
    ...
    {
    public:
        AZ_CLASS_ALLOCATOR(SkyAtmosphereComponentConfig, AZ::SystemAllocator)
        AZ_RTTI(SkyAtmosphereComponentConfig, "{1874446D-E0AA-4DFF-83A0-F7F76C10A867}", AZ::ComponentConfig);
